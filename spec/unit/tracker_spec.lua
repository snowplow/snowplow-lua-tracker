...
describe("tracker", function()
  ...
  it("trackScreenView() should call httpGet() with the correct payload in the querystring", function()
    ...
    assert.spy(t._httpGet).was_called_with("http://d3rkrsqld9gmqf.cloudfront.net/i?e=sv&sv_na=Game+HUD+2&dtm=1369330916000&p=tv&tv=lua-1.0-1&tid=100000&uid=user123&aid=wow%2Dext%2D1&res=1068x720&vp=420x360&cd=32")
  end)
  ...
  it("trackStructEvent() should call httpGet() with the correct payload in the querystring", function()
    ...
    assert.spy(t._httpGet).was_called_with("http://d3rkrsqld9gmqf.cloudfront.net/i?e=se&se_ca=shop&se_ac=add%2Dto%2Dbasket&se_pr=units&se_va=2&dtm=1369330909000&p=tv&tv=lua-1.0-1&tid=100000&uid=user123&aid=wow%2Dext%2D1&res=1068x720&vp=420x360&cd=32")
  end)
