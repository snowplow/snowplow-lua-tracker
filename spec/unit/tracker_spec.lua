...
describe("tracker", function()
	...
	it("trackScreenView() should error unless tstamp is a positive integer", function()
		local f = function()
			t:trackScreenView("Game HUD", "Load Save Game", false)
		end
	...
	it("trackStructEvent() should error unless action is a non-empty string", function()
		local f = function()
			t:trackStructEvent("shop", -456.021)
		end
	...
	it("trackStructEvent() should error unless label is a string or nil", function()
		local f = function()
			t:trackStructEvent("shop", "add-to-basket", {})
		end
	...
	it("trackStructEvent() should error unless property is a string or nil", function()
		local f = function()
			t:trackStructEvent("shop", "add-to-basket", nil, 23)
		end
	...
	it("trackScreenEvent() should error unless value is a number or nil", function()
		local f = function()
			t:trackStructEvent("shop", "add-to-basket", nil, "units", "212")
		end
	...
	it("trackUnstructEvent() should error unless properties is a non-empty table", function()
		local f = function()
			t:trackUnstructEvent("save-game", {})
		end
	...
	it("trackUnstructEvent() should error unless tstamp is a positive integer", function()
		local f = function()
			t:trackUnstructEvent("save-game", { save_id = 23 }, 23.232312)
		end
	...
	it(
		"trackUnstructEvent() should call httpGet() with the correct Base64-encoded payload in the querystring",
		function()
			t:encodeBase64(true)
			t:trackUnstructEvent(
				"load-game",
